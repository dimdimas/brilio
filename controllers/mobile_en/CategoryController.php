...
class CategoryController extends CController {
    ...
    function index($category = '', $halaman = '')
    {
        ...
        $this->_mobile_render('mobile_en/category/category', $data);
    ...
    function news_list($category, $halaman='')
    {
        ...
        $cacheKey = 'mobile_en_index_stream_news_' . $category . '-' . $halaman;
        ...
        $query_news_list = cache('mobile_en_query_'.$cacheKey.$offset.$total_news, function() use ($category, $offset , $total_news) {
