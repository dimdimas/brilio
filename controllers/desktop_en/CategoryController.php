...
class CategoryController extends CController {
    ...
    function index($category = '', $url_news = '', $url_paging_news = '')
    {
        ...
        [
            ...
            'share_story'       => $this->view('desktop_en/box/_email', [], TRUE),
            'stream_news'       => $stream_news,
            'trending'          => $this->view('desktop_en/box/right_trending', $this->_trending(7, 'Index category'), TRUE),
            'check_this_out'    => $this->view('/desktop/box/right_check_this_out', $this->_check_this_out('Index category', 8), TRUE),
            'bottom_menu'       => $this->view('desktop_en/box/bottom_menu', ['TE' => 'Index category' ], TRUE),
        ];

        $this->_render('desktop_en/category/category', $data);
    }
