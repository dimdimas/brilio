...
class MostCommentedController extends CController {
    ...
    function index($thn = '', $bln = '', $tgl = '') {
        ...
        $cacheKey = 'index_most_commented_mobile'.$tanggal.'-'.$thn;
        ...
        $ret = $this->_mobile_render('mobile/most-commented/index_most_commented', $data);
    ...
    function menu_type_date($thn, $bln, $tgl) {
        ...
        $cacheKey = 'menu_type_date-most_commented_mobile-'.$tanggal.'-'.$thn;
    ...
    function menu_per_date($thn, $bln, $tgl) {
        ...
        $cacheKey = 'menu_per_date_most_commented-mobile-'.$tanggal.'-'.$thn;
    ...
    function most_commented($thn, $bln, $tgl) {
        ...
        $interval = WebCache::App()->get_config('cachetime_short');
        $cacheKey = 'mobile_most_commented_'.date("Y-m-d").'-'.$thn;
        ...
        $news = cache("mobile_query_commented_".$cacheKey, function () use ($start_date, $end_date)
        {
