...
class MostSharedController extends CController {
    ...
    function index($thn = '', $bln = '', $tgl = '') {
        ...
        $cacheKey = 'index_most_shared_mobile_'.$tanggal.'-'.$thn;
        ...
        $ret = $this->_mobile_render('mobile/most-shared/index_most_shared', $data);
    ...
    function menu_type_date($thn, $bln, $tgl) {
        ...
        $cacheKey = 'menu_type_date_most_shared_mobile_'.$tanggal.'-'.$thn;
    ...
    function menu_per_date($thn, $bln, $tgl) {
        ...
        $cacheKey = 'menu_per_date_most_shared_mobile_'.$tanggal.'-'.$thn;
        if ($ret = checkCache($cacheKey))
            return $ret;
    ...
    function most_shared_news($thn, $bln, $tgl) {
        ...
        $interval = WebCache::App()->get_config('cachetime_short');
        $cacheKey = 'mobile_most_shared_news_'.date("Y-m-d").'-'.$thn;
        ...
        $news = cache("mobile_query_shared".$cacheKey, function () use ($start_date, $end_date)
        {
