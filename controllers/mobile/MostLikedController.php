...
class MostLikedController extends CController {
    ...
    function index($thn = '', $bln = '', $tgl = '') {
        ...
        $cacheKey = 'index_most_liked_mobile'.$tanggal.'-'.$thn;
        ...
        $ret =  $this->_mobile_render('mobile/most-liked/index_most_liked', $data);
    ...
    function breadcrumb($thn, $bln, $tgl) {
        ...
        $cacheKey = 'breadcrumb_most_liked_mobile-'.$tanggal.'-'.$thn;
    ...
    function menu_type_date($thn, $bln, $tgl) {
        ...
        $cacheKey = 'menu_type_date_most_liked_mobile'.$tanggal.'-'.$thn;
        if ($ret = checkCache($cacheKey))
            return $ret;
    ...
    function menu_per_date($thn, $bln, $tgl) {
        ...
        $cacheKey = 'menu_per_date_most_liked-mobile'.$tanggal.'-'.$thn;
        if ($ret = checkCache($cacheKey))
            return $ret;
    ...
    function most_liked_news($thn, $bln, $tgl) {
        ...
        $interval = WebCache::App()->get_config('cachetime_short');
        $cacheKey = 'mobile-most-liked-news-'.date("Y-m-d").'-'.$thn;
        ...
        $news = cache("mobile_query_liked_".$cacheKey, function () use ($start_date, $end_date)
        {
