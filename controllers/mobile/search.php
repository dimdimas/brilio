...
class Search extends CController {
    ...
    function content($post) {
        ...
        return $this->view('mobile/search/_content', $cn, true);
    }
    ...
    function list_front_tags_today() {
        ...
        if ($list_tags) {
            foreach ($list_tags as $a => $b) {
                ...
                $list_tags_list['LIST_TAGS_TODAY'] .= $this->view('mobile/category/today_tag/_list', $c, true);
            }
        } else {
            $list_tags_list['LIST_TAGS_TODAY'] .= "";
        }

        return $this->view('mobile/search/today_tag/_view', $list_tags_list, true);
    }
    ...
    function search($post) {
        ...
        return $this->view('mobile/search/news/_view', $records, true);
    }
    ...
    function most_viewed() {
        ...
        if ($most_viewed) {
            ...
            foreach ($most_viewed as $a => $b) {
                ...
                $list_most_viewed['LIST_MOST_VIEWED'] .= $this->view('mobile/search/most_viewed/_list', $c, true);
                $no++;
            }
        } else {
            $list_most_viewed['LIST_MOST_VIEWED'] .= "";
        }
        return $this->view('mobile/search/most_viewed/_view', $list_most_viewed, true);
    }
    ...
    function check_this_out() {
        ...
        if ($check_this_out) {
            ...
            foreach ($check_this_out as $a => $b) {
                ...
                $list_check_this_out['LIST_CHECK_THIS_OUT'] .= $this->view('mobile/search/check_this_out/_list', $c, true);
                $no++;
            }
        } else {
            $list_check_this_out['LIST_CHECK_THIS_OUT'] .= "";
        }
        return $this->view('mobile/search/check_this_out/_view', $list_check_this_out, true);
    }
    ...
    function latest() {
        ...
        if ($latest) {
            ...
            foreach ($latest as $b) {
                ...
                $list_latest['LIST_LATEST'] .= $this->view('mobile/read/latest/_list', $c, true);
                $no++;
            }
        } else {
            $list_latest['LIST_LATEST'] = "";
        }
        return $this->view('mobile/read/latest/_view', $list_latest, true);
    }
    ...
    function list_menu_tags_today($offcet, $limit, $order) {
        ...
        if ($list_tags) {
            foreach ($list_tags as $a => $b) {
                ...
                $list_tags_list['LIST_TAGS_TODAY'] .= $this->view('mobile/index/menu_today_tag/_list', $c, true);
            }
        } else {
            $list_tags_list['LIST_TAGS_TODAY'] .= "";
        }

        return $this->view('mobile/index/menu_today_tag/_view', $list_tags_list, true);
    }
