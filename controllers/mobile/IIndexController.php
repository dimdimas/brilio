...
class IndexController extends CController {
    ...
    function index() {
        ...
        (
            ...
            'meta'              => $meta,
            'TE_2'              => $TE_2,
            'announcer_index'   => $this->view('mobile/box/_announcer_banner', [], TRUE),
            ...
            'today_tags'        => $this->view('mobile/box/_tags_bottom', ['list_tags_bottom' => $this->_today_tags(0, 10, 0, $TE_2) ], true),
        );
